...
function Examples() {
  return (
    <>
      <div className="container grid grid-cols-2 gap-1  place-items-center mx-auto mt-[2rem] overflow-x-hidden pl-36 opacity-90">
        {/* 1 */}
        <Example
          image={
            <svg
      ...
      <a
        className="flex justify-center mt-12 underline underline-offset-2 text-xl"
        href="https://beta.openai.com/examples"
        target="_blank"
        rel="noopener noreferrer"
      >
        Find out more about examples
      </a>
      <Link to="/">
        <button
      ...
      <Link to="/dall-e">
        <button
          className="fixed left-40 bottom-7  hover: rounded-md z-10 hover:bg-opacity-5 hover:bg-white duration-300
                      p-3 border-[1px] border-solid border-white  text-center"
          type="button"
        >
          DALL·E 2
